...
if args.cam:
    ...
    bbox_min = np.asarray(transforms['xyz_min'])
    bbox_max = np.asarray(transforms['xyz_max'])
...
out_bbox.points = o3d.utility.Vector3dVector(bbox_min + aabb_01 * (bbox_max - bbox_min))
